...
const Add = () => {
  ...
  return <form className = "flex flex-col w-full items-start g-3">
    <div>
      <p className="mb-2">
        Upload Image
      </p>
    ...
    <div className="w-full">
      <p className="mb-2">
        Product Name
        <input className="w-full max-w-[500] px-3 py-2" type="text" placeholder="type here" required/>
      </p>
    </div>
    ...
    <div className="w-full">
      <p className="mb-2">
        ...
        <input className="w-full max-w-[500] px-3 py-2" type="textArea" placeholder="write content here" required/>
      </p>
    </div>
